...
# DATASET = 'Vaihingen'
# Stride_Size = 32
# MAIN_FOLDER = FOLDER + 'ISPRS_vaihingen/ISPRS_semantic_labeling_Vaihingen/'
# DATA_FOLDER = MAIN_FOLDER + 'top/top_mosaic_09cm_area{}.tif'
# # DSM_FOLDER = MAIN_FOLDER + 'dsm/dsm_09cm_matching_area{}.tif'
# DSM_FOLDER = MAIN_FOLDER + 'depth/top_mosaic_09cm_area{}.jpg'
# LABEL_FOLDER = MAIN_FOLDER + 'gts_for_participants/top_mosaic_09cm_area{}.tif'
# ERODED_FOLDER = MAIN_FOLDER + 'gts_eroded_for_participants/top_mosaic_09cm_area{}_noBoundary.tif'
# # ERODED_FOLDER = MAIN_FOLDER + 'gts_for_participants/top_mosaic_09cm_area{}.tif'
...
# test_ids = ['2_13','2_14','3_13','3_14','4_13','4_14','4_15','5_13','5_14','5_15','6_13','6_14','6_15','7_13','7_10']
# DATASET = 'Potsdam'
# Stride_Size = 128 # for quickly training
# MAIN_FOLDER = FOLDER + 'Potsdam/'
# DATA_FOLDER = MAIN_FOLDER + '4_Ortho_RGBIR/4_Ortho_RGBIR/top_potsdam_{}_RGBIR.tif'
# DSM_FOLDER = MAIN_FOLDER + '1_DSM_normalisation/1_DSM_normalisation/dsm_potsdam_{}_normalized_lastools.jpg'
# # DSM_FOLDER = MAIN_FOLDER + 'depth/top_potsdam_{}_RGB.jpg'
...
DATASET = 'Potsdam'
Stride_Size = 128 # for quickly training
MAIN_FOLDER = FOLDER + 'new_potsdam/'
DATA_FOLDER = MAIN_FOLDER + '4_Ortho_RGBIR/top_potsdam_{}_RGBIR.tif'
DSM_FOLDER = MAIN_FOLDER + '1_DSM_normalisation/dsm_potsdam_0{}_normalized_lastools.jpg'
# DSM_FOLDER = MAIN_FOLDER + 'depth/top_potsdam_{}_RGB.jpg'
...
def convert_from_color(arr_3d, palette=invert_palette):
    ...
    # pixel_counts = np.bincount(arr_2d.flatten())
    # print("每个像素值的出现次数:")
    # for value, count in enumerate(pixel_counts):
    #     if count > 0:
    #         print(f"像素值 {value}: {count} 次")
...
def metrics(predictions, gts, label_values=LABELS):
    ...
    logging.info("%d pixels processed" % (total))
    logging.info("Total accuracy : %.2f" % (accuracy))

    Acc = np.diag(cm) / cm.sum(axis=1)
    for l_id, score in enumerate(Acc):
        logging.info("%s: %.4f" % (label_values[l_id], score))
    logging.info("---")
    ...
    for l_id, score in enumerate(F1Score):
        logging.info("%s: %.4f" % (label_values[l_id], score))
    logging.info('mean F1Score: %.4f' % (np.nanmean(F1Score[:5])))
    logging.info("---")
