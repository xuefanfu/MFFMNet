...
# DATASET = 'Vaihingen'
# Stride_Size = 32
# MAIN_FOLDER = FOLDER + 'new_vaihingen/ISPRS_semantic_labeling_Vaihingen/'
# DATA_FOLDER = MAIN_FOLDER + 'top/top_mosaic_09cm_area{}.tif'
# DSM_FOLDER = MAIN_FOLDER + 'dsm/dsm_09cm_matching_area{}.tif'
# # DSM_FOLDER = MAIN_FOLDER + 'depth/top_mosaic_09cm_area{}.jpg'
# LABEL_FOLDER = MAIN_FOLDER + 'gts_for_participants/top_mosaic_09cm_area{}.tif'
...
class ISPRS_dataset(torch.utils.data.Dataset):
    ...
    def data_augmentation(cls, *arrays, flip=True, mirror=True):
        ...
        if flip and a1 < 0.5:
            will_flip = True
        if mirror and a2 < 0.5:
            will_mirror = True
        # print("a1{}, a2{}".format(a1, a2))
        # print("will_flip{}, will_mirror{}".format(will_flip, will_mirror))
...
# logging.info("Ground truth in numerical format has shape ({},{}) : \n".format(*array_gt.shape[:2]), array_gt)
...
def metrics(predictions, gts, label_values=LABELS):
    label_values = ["roads", "buildings", "low veg.", "trees", "cars", "clutter"]
    cm = confusion_matrix(
        gts,
        predictions,
