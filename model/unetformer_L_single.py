...
from .swin_transformer_L_single import SwinTransformer
...
class UNetFormer(nn.Module):
    def __init__(self,
        ...
        self.decoder = SwinTransformerSysfinal_decoder(num_classes=num_classes)
    ...
    def forward(self, x, y):
        ...
        if self.training:
            ...
            #     y = y.flatten(2).permute(0, 2, 1)
            #     y_downsample_d.append(y) 
            result = self.decoder(x, x_downsample)
...
if  __name__ == "__main__":
    ...
    for i in range(100):
        print(i)
        result, resultd, x = model(tensor_random, tensor_random_d)
