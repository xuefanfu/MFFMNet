...
class BiMultiHeadAttention(nn.Module):
    ...
    def forward(self, img, d, attention_mask_v=None, attention_mask_l=None):
        ...
        # print("attn_weights",value_d_states.shape)

        src_len = key_states.size(1) # 4
        # print("query_states",key_states.shape)
        # print("query_states",query_states.shape)

        # print("ccc----------------------",cc2(query_states, key_states))
        ...
        # print("dddddddddddddddddd--------------------------------",attn_weights_v.shape)

        attn_probs_v = F.dropout(attn_weights_v, p=self.dropout, training=self.training)
        # attn_probs_l = F.dropout(attn_weights_l, p=self.dropout, training=self.training)

        attn_output_v = torch.bmm(attn_probs_v, value_d_states) # [4, 17821, 256]
        # print("ccc----------------------attn_output_v",cc2(query_states, attn_output_v))
        # print("ccc----------------------qkqkqkqkqkqkqqkqkqkqkqkqk--------------------",cc2(key_states, attn_output_v))
        # print("ccc----------------------qkqkqkqkqkqkqqkqkqkqkqkqk",cc2(value_d_states, attn_output_v))
        # print("-----------------------attn_output_v",attn_output_v.shape)
        ...
        # print("dddddddddddddddddd---------------0000000000000000000000",attn_output_v.shape)
        attn_output_v = attn_output_v.transpose(1, 2)
        attn_output_v = attn_output_v.reshape(bsz, tgt_len, self.embed_dim)
        # print("dddddddddddddddddd",attn_output_v.shape)
        ...
        # print("attn_output_v------------------finalfinal",attn_output_v.shape)
...
class BiAttentionBlock(nn.Module):
    ...
    def forward(self, img, d, attention_mask_v=None, attention_mask_l=None):
        ...
        # print("atten_img2d", atten_img2d.shape)
        # print("img", img.shape)
        # print("d", d.shape)
