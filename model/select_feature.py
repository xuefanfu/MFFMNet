...
if __name__ == "__main__":
    ...
    input_data = torch.rand([1, 17821, 256]).cuda()
    input_data_d = torch.rand([1, 17821, 256]).cuda()
    print("input",input_data.shape)
    model = BiAttentionBlock(img_dim=256, d_dim=256, embed_dim=1024, num_heads=4).cuda()
