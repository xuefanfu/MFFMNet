...
class UNetFormer(nn.Module):
    ...
    def forward(self, x, y):
        ...
        # y_local_features_embed torch.Size([8, 4096, 256])
        # y_local_features_embed torch.Size([8, 1024, 256])
        # y_local_features_embed torch.Size([8, 256, 256])
        # y_local_features_embed torch.Size([8, 64, 256])
        # for y_ in y_local_features_embed:
        #     print("y_local_features_embed", y_.shape)
