...
if __name__ == '__main__':
    ...
    inp_img = torch.rand([10, 256, 64,64]).cuda()
    baseFeature = BaseFeatureExtraction(dim=256, num_heads = 8).cuda()
    detailFeature = DetailFeatureExtraction().cuda()
    base = baseFeature(inp_img)
    detail = detailFeature(inp_img)
    print("base", base.shape)
    print("detail", detail.shape)
    # base_feature, detail_feature, out_enc_level1 = modelE(inp_img)
